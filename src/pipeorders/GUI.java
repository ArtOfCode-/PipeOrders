...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        resultsLabel.setText("Total cost: £0.00");
        ...
        resetTotal.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                resetTotalMouseReleased(evt);
            }
        });
                ...
                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(resetTotal, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addGap(500, 500, 500))
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        .addGap(29, 29, 29)
    ...
    private void gradeThreeButtonMouseReleased(java.awt.event.MouseEvent evt) {                                               
        gradeAdjust();
        orderCheck();
    }                                              

    private void gradeTwoButtonMouseReleased(java.awt.event.MouseEvent evt) {                                             
        gradeAdjust();
        orderCheck();
    }                                            

    private void gradeOneButtonMouseReleased(java.awt.event.MouseEvent evt) {                                             
        gradeAdjust();
        orderCheck();
    }                                            

    private void gradeFourButtonMouseReleased(java.awt.event.MouseEvent evt) {                                              
        gradeAdjust();
        orderCheck();
    }                                             

    private void gradeFiveButtonMouseReleased(java.awt.event.MouseEvent evt) {                                              
        gradeAdjust();
        orderCheck();
    }                                             

    private void ResetMouseReleased(java.awt.event.MouseEvent evt) {                                    
        resetForm();
    }                                   

    private void colourNoneRadioMouseReleased(java.awt.event.MouseEvent evt) {                                              
        colourAdjust();
        orderCheck();
    }                                             

    private void colourOneRadioMouseReleased(java.awt.event.MouseEvent evt) {                                             
        colourAdjust();
        orderCheck();
    }                                            

    private void colourTwoRadioMouseReleased(java.awt.event.MouseEvent evt) {                                             
        colourAdjust();
        orderCheck();
    }                                            

    private void innerCheckBoxMouseReleased(java.awt.event.MouseEvent evt) {                                            
        innerAdjust();
        orderCheck();
    }                                           

    private void outerCheckBoxMouseReleased(java.awt.event.MouseEvent evt) {                                            
        outerAdjust();
        orderCheck();
    }                                           

    private void lengthFieldKeyReleased(java.awt.event.KeyEvent evt) {                                        
        orderCheck();
    }                                       

    private void diameterFieldKeyReleased(java.awt.event.KeyEvent evt) {                                          
        orderCheck();
    }                                         
    ...
    private void resetTotalMouseReleased(java.awt.event.MouseEvent evt) {                                         
        PipeOrders.resetTotal();
    }                                        
